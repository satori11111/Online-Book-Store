...
public class BookServiceTest {
    ...
    @Test
    @DisplayName("getBookById_returnsBook_ok")
    public void getBookById_returnsBook_ok() {
    ...
    @Test
    @DisplayName("getBookById_NonExistingId_throwsException_notOk")
    public void getBookById_NonExistingId_throwsException_notOk() {
    ...
    public void createBook_returnsCreatedBook_ok() {
    ...
    @Test
    @DisplayName("findAllBooks_returnsList_ok")
    public void findAllBooks_returnsList_ok() {
    ...
    public void updateBook_returnsUpdatedBook_ok() {
        when(bookRepository.save(any(Book.class))).thenReturn(book);
        when(bookMapper.toModel(any(CreateBookRequestDto.class))).thenReturn(book);
        when(bookMapper.toDto(any(Book.class))).thenReturn(bookDto);
        when(bookRepository.findByIdBookAndItsCategories(anyLong())).thenReturn(Optional.of(book));
    ...
    @Test
    @DisplayName("updateBook_InvalidId_throwsException_notOk")
    public void updateBook_InvalidId_throwsException_notOk() {
        when(bookRepository.findByIdBookAndItsCategories(anyLong())).thenReturn(Optional.empty());
    ...
    @Test
    @DisplayName("deleteBookById_InvalidId_throwsException_notOk")
    public void deleteBookById_InvalidId_throwsException_notOk() {
        when(bookRepository.findByIdBookAndItsCategories(anyLong())).thenReturn(Optional.empty());
    ...
    @Test
    @DisplayName("searchBooks_returnsMatchingBooks_ok")
    public void searchBooks_returnsMatchingBooks_ok() {
