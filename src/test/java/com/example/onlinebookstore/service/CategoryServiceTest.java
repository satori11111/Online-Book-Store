...
public class CategoryServiceTest {
    ...
    @Test
    @DisplayName("getCategoryById_NonExistingId_throwsException_notOk")
    public void getCategoryById_NonExistingId_throwsException_notOk() {
    ...
    public void getCategoryById_returnsCategory_ok() {
    ...
    @Test
    @DisplayName("findAllCategories_returnsSet_ok")
    public void findAllCategories_returnsSet_ok() {
    ...
    public void createCategory_returnsCreatedCategory_ok() {
    ...
    public void updateCategory_returnsUpdatedCategory_ok() {
        when(categoryRepository.save(any(Category.class))).thenReturn(category);
        when(categoryMapper.toModel(any(CreateCategoryRequestDto.class))).thenReturn(category);
        when(categoryMapper.toDto(any(Category.class))).thenReturn(categoryDto);
        when(categoryRepository.findById(anyLong())).thenReturn(Optional.of(category));
    ...
    @Test
    @DisplayName("updateCategory_InvalidId_throwsException_notOk")
    public void updateCategory_InvalidId_throwsException_notOk() {
        when(categoryRepository.findById(anyLong())).thenReturn(Optional.empty());
        EntityNotFoundException actual = assertThrows(EntityNotFoundException.class,
    ...
    @Test
    @DisplayName("deleteCategoryById_InvalidId_throwsException_notOk")
    public void deleteCategoryById_InvalidId_throwsException_notOk() {
        when(categoryRepository.findById(anyLong())).thenReturn(Optional.empty());
    ...
    public void getBooksByCategoryId_returnsMatchingBooks_ok() {
